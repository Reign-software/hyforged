...
public class ComponentUpdate {
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 212) {
         ...
         if ((nullBits[0] & 32) != 0) {
            ...
            int posx = offset + 212 + entityUIComponentsOffset;
         ...
         if ((nullBits[0] & 64) != 0) {
            ...
            int posxx = offset + 212 + combatTextUpdateOffset;
         ...
         if ((nullBits[0] & 128) != 0) {
            ...
            int posxxx = offset + 212 + modelOffset;
         ...
         if ((nullBits[1] & 1) != 0) {
            ...
            int posxxxx = offset + 212 + skinOffset;
         ...
         if ((nullBits[1] & 2) != 0) {
            ...
            int posxxxxx = offset + 212 + itemOffset;
         ...
         if ((nullBits[1] & 4) != 0) {
            ...
            int posxxxxxx = offset + 212 + equipmentOffset;
         ...
         if ((nullBits[1] & 8) != 0) {
            ...
            int posxxxxxxx = offset + 212 + entityStatUpdatesOffset;
         ...
         if ((nullBits[1] & 16) != 0) {
            ...
            int posxxxxxxxx = offset + 212 + entityEffectUpdatesOffset;
         ...
         if ((nullBits[1] & 32) != 0) {
            ...
            int posxxxxxxxxx = offset + 212 + interactionsOffset;
         ...
         if ((nullBits[1] & 64) != 0) {
            ...
            int posxxxxxxxxxx = offset + 212 + soundEventIdsOffset;
         ...
         if ((nullBits[1] & 128) != 0) {
            ...
            int posxxxxxxxxxxx = offset + 212 + interactionHintOffset;
         ...
         if ((nullBits[2] & 1) != 0) {
            ...
            int posxxxxxxxxxxxx = offset + 212 + activeAnimationsOffset;
   ...
   public int hashCode() {
      ...
      result = 31 * result + Arrays.hashCode((Object[])this.activeAnimations);
