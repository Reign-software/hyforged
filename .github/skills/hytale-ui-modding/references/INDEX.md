...
| [item-hud-ui.md](item-hud-ui.md) | **Item HUD UI** - Attaching .ui overlays to items via the item JSON `HudUI` array field. Asset-driven, client-managed lifecycle. `ItemHudUIType` (Hud/Legend). Dynamic updates via MHUD. Added in server 2026.02.26-7681d338c. |
...
| Attach a HUD overlay to an item | [item-hud-ui.md](item-hud-ui.md) - Item JSON HudUI section |
